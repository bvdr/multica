...
| `environment_prepare_failed` | The daemon could not prepare the working directory for this run on its own machine | Check that machine's disk space, permissions, and whether the directory is still in use, then retry |
