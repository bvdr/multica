    ...
    entries: [
      {
        version: "0.4.37",
        date: "2026-08-31",
        title: "企业微信机器人更可靠、CodeArts 运行时、原生 iPad 支持",
        changes: [],
        features: [
          "自托管的企业微信机器人，多台服务器下也能稳定回复。",
          "企业微信回复没送达时，现在能看到具体原因。",
          "可以用华为云 CodeArts 搭建自定义运行时了。",
          "CodeArts 的任务能续接会话，也能用 MCP 和本地技能。",
          "Multica 可以原生安装到 iPad，横竖屏都能用。",
        ],
        improvements: [
          "Issue 列表和智能体技能的加载更快了。",
          "自托管服务的后台开销更小，运行更轻。",
          "连接卡住时，网页服务依然能正常响应。",
          "智能体输出里的路径不再被错误地遮掉一部分。",
          "中文、日文、韩文界面的文案更完整，用词也更统一。",
        ],
        fixes: [
          "窄窗口下 Analytics 排行榜可以横向滚动查看。",
          "Codex 会话不再在启动阶段失败。",
          "聊天会停在最新回复，不再跳动或闪现。",
          "本地技能请求会唤醒在线的本机后台，不再直接失败。",
          "桌面端会自动恢复意外停止的本机后台。",
          "移动端 Issue 页头更紧凑，头像依然好点。",
          "从更早的自托管版本升级不再卡住。",
          "换工作目录后，Pi 和 Oh My Pi 的会话会保留。",
          "删除工作区的提示，只列出真正会被删除的内容。",
          "长时间运行和排队中的任务不再被误取消。",
        ],
      },
      {
