    ...
    entries: [
      {
        version: "0.4.38",
        date: "2026-09-01",
        title: "Codex 的 Standard 速度、跟随界面语言的日期与数字、更连续的智能体分支",
        changes: [],
        features: [
          "Codex 智能体可以直接选择 Standard 速度，不再只有 Fast 或本机默认。",
        ],
        improvements: [
          "日语和韩语界面里 Issue 与任务的说法保持一致。",
          "工作区历史变多后，自托管服务器的后台重复工作更少。",
          "任务记录和桌面端诊断里的长文本截断得更干净。",
        ],
        fixes: [
          "使用本地目录时，同一个 Issue 会一直用同一个工作分支。",
          "后续智能体能接着上一轮的改动继续，不会丢失。",
          "含多张内联图片的 Issue 页面返回时不再闪烁。",
          "私有图片也不会在不同账号之间被复用。",
          "日期、时间、数字、金额和图表数值跟随你在 Multica 选的语言。",
          "Windows 上的 Pi 智能体可以正常续接，不再启动失败。",
          "桌面端的守护进程设置、日志和重新登录提示都有本地语言。",
          "编辑评论触发下一轮执行时，进行中的会话不会丢失。",
        ],
      },
      {
        version: "0.4.37",
