      ...
      entries: [
        {
          version: "0.4.38",
          date: "2026-09-01",
          title: "Codex の Standard 速度、表示言語に合う日付と数値、より連続したエージェントの作業ブランチ",
          changes: [],
          features: [
            "Codex のエージェントで、Fast や端末の既定だけでなく Standard の速度も選べます。",
          ],
          improvements: [
            "日本語と韓国語の表示で、Issue とタスクの呼び方がそろいました。",
            "履歴が増えても、セルフホストのサーバーの重複したバックグラウンド処理が減りました。",
            "タスクの記録やデスクトップの診断で、長い文章の省略がきれいになりました。",
          ],
          fixes: [
            "ローカルフォルダーを使う Issue は、実行をまたいで同じ作業ブランチを使います。",
            "次のエージェントは前回の変更をそのまま引き継ぎ、失われません。",
            "画像が複数ある Issue のページに戻っても、ちらつきません。",
            "非公開の画像が別のアカウントで使い回されることもありません。",
            "日付、時刻、数値、金額、グラフの数字が、Multica で選んだ言語に合わせて表示されます。",
            "Windows の Pi エージェントが、起動に失敗せず再開できます。",
            "デスクトップ版のデーモンの設定、ログ、再サインインの案内が各言語で表示されます。",
            "コメントを編集して次の実行が始まっても、進行中のセッションが失われません。",
          ],
        },
        {
          version: "0.4.37",
