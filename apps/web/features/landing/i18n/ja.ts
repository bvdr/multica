      ...
      entries: [
        {
          version: "0.4.37",
          date: "2026-08-31",
          title: "より確実な WeCom ボット、CodeArts ランタイム、iPad ネイティブ対応",
          changes: [],
          features: [
            "セルフホストの WeCom ボットが、複数台構成でも確実に返信します。",
            "WeCom の返信が届かなかったときに、その理由が分かります。",
            "Huawei Cloud CodeArts で独自のランタイムを作れます。",
            "CodeArts の実行は前のセッションを引き継ぎ、MCP とローカルのスキルも使えます。",
            "Multica を iPad にネイティブ インストールでき、縦横どちらでも使えます。",
          ],
          improvements: [
            "Issue 一覧とエージェントのスキルの読み込みが速くなりました。",
            "セルフホストのサーバーは裏側の処理が減り、より軽く動きます。",
            "接続が滞っても、Web サービスは応答を続けます。",
            "エージェントの出力で、パスの一部が誤って隠れなくなりました。",
            "日本語・中国語・韓国語の画面の文言が揃い、用語も統一されました。",
          ],
          fixes: [
            "狭い画面でも Analytics のランキングを横にスクロールできます。",
            "Codex のセッションが開始時に失敗しなくなりました。",
            "チャットが最新の返信に留まり、跳ねたり点滅したりしません。",
            "ローカルのスキルの要求がデーモンを起こし、そのまま失敗しません。",
            "デスクトップ版が、予期せず止まったデーモンを復帰させます。",
            "モバイルの Issue ヘッダーが引き締まり、アイコンも押しやすいままです。",
            "以前のセルフホスト版からのアップグレードが止まらなくなりました。",
            "作業フォルダーを変えても、Pi と Oh My Pi のセッションが残ります。",
            "ワークスペース削除の確認に、実際に消えるものだけが並びます。",
            "長時間の実行や待機中のタスクが、誤って取り消されません。",
          ],
        },
        {
          version: "0.4.36",
