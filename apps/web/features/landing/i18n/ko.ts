      ...
      entries: [
        {
          version: "0.4.37",
          date: "2026-08-31",
          title: "더 안정적인 WeCom 봇, CodeArts 런타임, iPad 네이티브 지원",
          changes: [],
          features: [
            "셀프호스트 WeCom 봇이 서버가 여러 대일 때도 안정적으로 답합니다.",
            "WeCom 답장이 전달되지 않으면 그 이유를 확인할 수 있습니다.",
            "Huawei Cloud CodeArts로 사용자 지정 런타임을 만들 수 있습니다.",
            "CodeArts 실행은 이전 세션을 이어가고 MCP와 로컬 스킬도 쓸 수 있습니다.",
            "Multica를 iPad에 네이티브로 설치하고 가로·세로 모두 사용할 수 있습니다.",
          ],
          improvements: [
            "Issue 목록과 에이전트 스킬 불러오기가 빨라졌습니다.",
            "셀프호스트 서버는 뒤에서 하는 일이 줄어 더 가볍게 돌아갑니다.",
            "연결이 멈춰도 웹 서비스가 계속 응답합니다.",
            "에이전트 출력에서 경로 일부가 잘못 가려지지 않습니다.",
            "중국어, 일본어, 한국어 화면 문구가 빠짐없이 채워지고 용어도 통일되었습니다.",
          ],
          fixes: [
            "좁은 화면에서도 Analytics 순위 목록을 가로로 스크롤할 수 있습니다.",
            "Codex 세션이 시작 단계에서 실패하지 않습니다.",
            "채팅이 최신 답변에 머물고 튀거나 깜빡이지 않습니다.",
            "로컬 스킬 요청이 데몬을 깨우므로 그대로 실패하지 않습니다.",
            "데스크톱 앱이 갑자기 멈춘 데몬을 다시 살립니다.",
            "모바일 Issue 헤더가 간결해지고 아바타는 그대로 누르기 쉽습니다.",
            "이전 셀프호스트 버전에서의 업그레이드가 멈추지 않습니다.",
            "작업 폴더를 바꿔도 Pi와 Oh My Pi 세션이 유지됩니다.",
            "워크스페이스 삭제 안내에 실제로 지워지는 항목만 표시됩니다.",
            "오래 실행되는 작업과 대기 중인 작업이 실수로 취소되지 않습니다.",
          ],
        },
        {
          version: "0.4.36",
