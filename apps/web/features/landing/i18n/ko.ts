      ...
      entries: [
        {
          version: "0.4.38",
          date: "2026-09-01",
          title: "Codex의 Standard 속도, 표시 언어에 맞는 날짜와 숫자, 더 이어지는 에이전트 작업 브랜치",
          changes: [],
          features: [
            "Codex 에이전트에서 Fast나 내 컴퓨터 기본값 외에 Standard 속도도 고를 수 있습니다.",
          ],
          improvements: [
            "일본어와 한국어 표시에서 Issue와 태스크를 부르는 말이 통일되었습니다.",
            "기록이 늘어나도 셀프 호스팅 서버의 중복된 백그라운드 작업이 줄었습니다.",
            "태스크 기록과 데스크톱 진단에서 긴 글이 더 깔끔하게 줄어듭니다.",
          ],
          fixes: [
            "로컬 폴더를 쓰는 Issue는 실행이 바뀌어도 같은 작업 브랜치를 씁니다.",
            "다음 에이전트가 지난 회차의 변경을 그대로 이어받아 잃지 않습니다.",
            "인라인 이미지가 여러 개인 Issue 페이지로 돌아가도 깜빡이지 않습니다.",
            "비공개 이미지가 다른 계정에서 재사용되지도 않습니다.",
            "날짜, 시간, 숫자, 금액, 차트 값이 Multica에서 고른 언어에 맞춰 표시됩니다.",
            "Windows의 Pi 에이전트가 시작 실패 없이 이어서 실행됩니다.",
            "데스크톱 앱의 데몬 설정, 로그, 재로그인 안내가 사용 언어로 표시됩니다.",
            "댓글을 수정해 다음 실행이 시작되어도 진행 중인 세션이 사라지지 않습니다.",
          ],
        },
        {
          version: "0.4.37",
