 ...
 * `Issues | ContextPRO` and `Changelog | ContextPRO` can never drift into two
...
export const SITE_TITLE = "ContextPRO — Project Management for Human + Agent Teams";

/** Appended to every page-specific title. */
export const TITLE_SUFFIX = " | ContextPRO";
