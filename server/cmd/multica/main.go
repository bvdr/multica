...
var rootCmd = &cobra.Command{
	Use:           "multica",
	Short:         "ContextPRO CLI — local agent runtime and management tool",
	Long:          "Work seamlessly with ContextPRO from the command line.",
	SilenceUsage:  true,
	SilenceErrors: true,
}
...
func init() {
	...
	rootCmd.PersistentFlags().String("server-url", "", "ContextPRO server URL (env: MULTICA_SERVER_URL)")
