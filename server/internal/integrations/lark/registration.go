...
//     and an expiry. ContextPRO renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to ContextPRO. Empty defaults
	// to "multica".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with ContextPRO's `source`
...
// cannot attribute installs back to ContextPRO in their analytics.
//
