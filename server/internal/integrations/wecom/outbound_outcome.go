...
// shape of GH #7215 and #6890: the answer is in the ContextPRO transcript, the
...
const (
	// skipOriginNotChannel — the turn was asked in the ContextPRO web UI on a
	// session that originated in WeCom, so its answer belongs in ContextPRO only.
