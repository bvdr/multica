...
//     so the agent still discovers the ContextPRO skill, just under a
//     different directory name.
//   - For ContextPRO-only namespaces (.agent_context/issue_context.md,
...
// down a ContextPRO skill without colliding with a user-installed skill
